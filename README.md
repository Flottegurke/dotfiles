...
built with [flake-parts](https://flake.parts), [home-manager](https://nix-community.github.io/home-manager) and [gnu-stow](https://www.gnu.org/software/stow), with [hyprland](https://hypr.land) as the wayland compositor on desktops.
