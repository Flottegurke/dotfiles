...
Minimalist **Hyprland dotfiles** for my personal Arch Linux setup - managed with [GNU Stow](https://www.gnu.org/software/stow/).
...
All setup instructions, configuration steps, keybindings, and informtions can be found in the [**Wiki**](https://github.com/Flottegurke/dotfiles/wiki):
...
- ⌨️ List of all custom [Keybindings](https://github.com/flottegurke/dotfiles/wiki/Keybindings)
- ⚙️ [OS Setup](https://github.com/flottegurke/dotfiles/wiki/OS-Setup) instructions
- 🖥️ [VM Setup](https://github.com/flottegurke/dotfiles/wiki/VM-Setup) guide
